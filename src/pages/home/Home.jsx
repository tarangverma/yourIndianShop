      ...
      <div id="Site">
        ...
        <div id="homesec" className="hero-cont">
          ...
          <div id="hero-log-pop">
            ...
            <div className="lg-btn">
              <div className="btn btn-b">Sign up</div>
              OR
              <div className="btn btn-o">Log in</div>
            </div>
          </div>
          {/* <div id="ver-in">
        ...
        <div id="Site" className="bkl">
          <div id="indianshopcart" style={{ padding: "10vh 0px" }}>
            ...
            <br />
            <center>
              <Link to="/in-sites" className="btn btn-gd">
                Shop Now
              </Link>
            </center>
            <br />
          ...
          >
            <defs>
              <linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0">
                <stop stop-color="#ff7315" offset="0%"></stop>
                {/* <stop stop-color="#093637" offset="0%"></stop> */}
                {/* <stop stop-color="rgba(249, 212, 35, 1)" offset="100%"></stop> */}
              </linearGradient>
            </defs>
            <path
        ...
        <div id="contact-sec">
          ...
          <div className="con-ftr">
            <div className="btn btn-gd">SIGN UP</div>
            <div className="btn btn-gd">OFFERS</div>
            <div className="btn btn-gd">PLANS</div>
          </div>
        </div>
        <Footer />
      </div>
